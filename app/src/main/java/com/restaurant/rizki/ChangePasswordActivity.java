...
import com.restaurant.rizki.data.Constants;
import com.restaurant.rizki.model.RegisterResponse;
import com.restaurant.rizki.session.Session;
import com.restaurant.rizki.utils.DialogUtils;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void updateUser() {
        ...
        AndroidNetworking.post(Constants.UPDATE_PROFILE_USER + "/" + "rizki").addBodyParameter("nama", name.getText().toString()).addBodyParameter("old_password", oldPass.getText().toString()).addBodyParameter("new_password", newPass.getText().toString()).build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
            @Override
